...
INSERT INTO items (admin_id, title, description, thumbnail_photo_url, cover_photo_url, cost, date, sold, country, city, province)
VALUES (1, 'Colourful Floers', 'This plant is the perfect addition to any modern home.', 'https://images.unsplash.com/photo-1510520745063-ceaa7314a820?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8cGxhbnQlMjBwb3R8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60', 'https://images.unsplash.com/photo-1510520745063-ceaa7314a820?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8cGxhbnQlMjBwb3R8ZW58MHwwfDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60', 50, '2022-03-05', False, 'Canada', 'Montreal', 'QC');

INSERT INTO items (admin_id, title, description,thumbnail_photo_url, cover_photo_url, cost, date, sold, country, city, province)
VALUES (3, 'Purple Blossom', 'Give it the right care, and these prickly plants will show you beautiful flowers.Feel free to message me.', 'https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHBsYW50JTIwcG90fGVufDB8MHwwfHw%3D&auto=format&fit=crop&w=500&q=60', 'https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHBsYW50JTIwcG90fGVufDB8MHwwfHw%3D&auto=format&fit=crop&w=500&q=60', 30, '2022-01-15', FALSE, 'Canada', 'London', 'ON');
...
INSERT INTO items (admin_id, title,description, thumbnail_photo_url, cover_photo_url, cost, date, sold, country, city, province)
VALUES (6, 'Pink Flowers', 'Add some color to your house with this lovely assortment.' , 'https://images.unsplash.com/photo-1503153181849-4e4f85a341ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=627&q=80', 'https://images.unsplash.com/photo-1503153181849-4e4f85a341ce?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=627&q=80', 65, '2022-02-05', True, 'Canada', 'Montreal', 'QC');
